...
{
    return createAction(USER_ACTION_TYPE.SIGNUP_START, { email, password, displayName});
}
export const signupSuccess = (user, additionalDetails) => createAction(USER_ACTION_TYPE.SIGNUP_SUCCESS, { user, additionalDetails })
